            ...
            <div class="header-top-wrp">
                <ul class="info">
                    <li><svg width="15" height="12" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="#0" class="ms-1">info@xcodetechsolutions.com</a>
                    </li>
                    <li class="ms-4"><svg width="16" height="15" viewBox="0 0 16 15" fill="none"
                        ...
                        <a href="#0" class="ms-1">+91 9408890744</a>
                    </li>
                </ul>
                <ul class="link-info">
        ...
        <div class="container header__container">
            <div class="header__main">
                ...
                <nav>
                     <ul>
                         ...
                         <li>
                             ...
                             <ul class="sub-menu">
                                 <li>
                                     <a href="service-solutions.php">IT Solutions</a>
                                 </li>
                                 <li>
                ...
                <div class="d-none d-lg-inline-block">
                    <a href="contact.php" class="btn-one">Get A Quote <i

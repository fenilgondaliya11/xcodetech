            ...
            <div class="footer__wrp pt-100 pb-100">
                <div class="footer__item item-big wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                    <a href="index.html" class="logo mb-10">
                        <img src="assets/images/logo/Xlogo.png" alt="logo">
                    </a>
                    <p>We are a leading IT solutions company dedicated to providing innovative technology services and
                        digital transformation solutions to businesses worldwide.</p>
                ...
                <div class="footer__item item-sm wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    ...
                    <ul>
                        <li><a href="about.html"><i class="fa-regular fa-angles-right me-1"></i> About</a></li>
                ...
                <div class="footer__item item-big wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                    ...
                    <p class="mb-20">603 xcode. Rajkot, Gujarat 360001</p>
            ...
            <div class="container">
                <div
                    ...
                    <p class="wow fadeInDown" data-wow-delay="00ms" data-wow-duration="1500ms">&copy; All Copyright 2024
                        by <a href="#0">XcodeTechSolutions</a></p>
